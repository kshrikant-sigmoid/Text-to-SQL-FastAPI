...
export default function History({ username, selectedQuestion: initialSelectQuestion }) {
  const [history, setHistory] = useState([]);
  const [selectedQuestion, setSelectedQuestion] = useState(initialSelectQuestion);
